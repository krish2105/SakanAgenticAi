...
logs). Set EMAIL_PROVIDER=smtp + the EMAIL_SMTP_* vars to actually deliver via
any SMTP relay (Resend, Postmark, SES, Gmail app-password, etc.). Swapping in a
vendor HTTP API later means adding one more branch here and nothing else.
"""
