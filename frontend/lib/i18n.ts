...
const en: Dict = {
  ...
  "auth.registerDescription": "A free account gets you unlimited comps search and 5 full-pipeline queries a month.",
  "auth.fullNameOptional": "Full name (optional)",
  "auth.emailPlaceholder": "you@brokerage.ae",
  "auth.createAccount": "Create account",
  "auth.pleaseWait": "Please wait…",
  "auth.continueAsDemo": "Continue as Demo",
  "auth.demoDescription": "No signup — explore the real pipeline instantly.",
  ...
  "comps.provenanceDldBayut": "DLD (via Bayut)",
...
const ar: Dict = {
  ...
  "auth.registerDescription": "يمنحك الحساب المجاني بحث مقارنات غير محدود و٥ استعلامات كاملة شهريًا.",
  "auth.fullNameOptional": "الاسم الكامل (اختياري)",
  "auth.emailPlaceholder": "you@brokerage.ae",
  "auth.createAccount": "إنشاء حساب",
  "auth.pleaseWait": "يرجى الانتظار…",
  "auth.continueAsDemo": "المتابعة كتجربة",
  "auth.demoDescription": "بدون تسجيل — جرّب النظام الفعلي فورًا.",
  ...
  "comps.provenanceDldBayut": "دائرة الأراضي (عبر Bayut)",
  ...
  "footer.faq": "الأسئلة الشائعة للمستثمرين",
